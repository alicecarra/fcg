...
int main()
{
    ...
    GLFWwindow *window;
    window = glfwCreateWindow(800, 800, "INF01047 - 00303139 - Alice Carra", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // variáv1eis g_CameraDistance, g_CameraPhi, e g_CameraTheta são
...
void KeyCallback(GLFWwindow *window, int key, int scancode, int action, int mod)
{
    ...
    {
        g_CamDistanceY -= (camera_step * sin_g_CameraPhi);
        g_CamDistanceZ -= (camera_step * cos_g_CameraPhi * cos_g_CameraTheta);
        g_CamDistanceX -= (camera_step * cos_g_CameraPhi * sin_g_CameraTheta);
    }
    ...
    {
        g_CamDistanceX -= (camera_step * cos_g_CameraPhi * cos_g_CameraTheta);
        g_CamDistanceZ += (camera_step * cos_g_CameraPhi * sin_g_CameraTheta);
    }
